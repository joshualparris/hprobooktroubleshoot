...
Windows CI runs the app self-test on `windows-latest`, then builds an installable ZIP and SHA-256 file:

```powershell
.\scripts\package-windows-crash-doctor.ps1
```

The ZIP contains the app, installer, ProBook profile and canonical deep collector.
